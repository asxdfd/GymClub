...
public class PlayService extends Service implements
    ...
    private boolean isPlayingBeforeExit = false;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    Toast.makeText(getApplicationContext(), "加载成功", Toast.LENGTH_SHORT);
                    break;
                default:
                    break;
            }
